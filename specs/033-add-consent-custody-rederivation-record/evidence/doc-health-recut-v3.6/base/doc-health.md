...
Canon share by words: 39.8% (360528 canon words / 906019 governance words, promoted specs included).
Findings: 10 critical, 6 error, 57 warning, 15 info. New regressions vs previous report: 0.
...
- [info] openxFactory:contracts/README.md — bytes differ from the digest 'contract-v3.5' records (editorial member — expected between cuts)
- [info] openxFactory:contracts/manifest.yaml — bytes differ from the digest 'contract-v3.5' records (editorial member — expected between cuts)
...
- severity=info family=release-inventory-drift repo=openxFactory path=contracts/README.md rule="bytes differ from the digest 'contract-v3.5' records (editorial member — expected between cuts)" action="cut a release through the bundle realization order; never hand-edit an inventory or contract_bundle_version to make this comparison pass" class="auto-fixable"
- severity=info family=release-inventory-drift repo=openxFactory path=contracts/manifest.yaml rule="bytes differ from the digest 'contract-v3.5' records (editorial member — expected between cuts)" action="cut a release through the bundle realization order; never hand-edit an inventory or contract_bundle_version to make this comparison pass" class="auto-fixable"
