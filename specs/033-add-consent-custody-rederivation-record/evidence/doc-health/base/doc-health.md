...
Canon share by words: 39.8% (358220 canon words / 900520 governance words, promoted specs included).
Findings: 10 critical, 7 error, 67 warning, 15 info. New regressions vs previous report: 0.
...
- [warning] openxFactory:docs/deployment-worker-model.md — draft without transition for 62 days
- [warning] openxFactory:docs/dogfood-content-migration-plan.md — draft without transition for 62 days
...
- [warning] openxFactory:docs/feature-decomposition.md — draft without transition for 62 days
- [warning] openxFactory:docs/intake-and-installer-plan.md — draft without transition for 63 days
- [warning] openxFactory:docs/merge-council.md — draft without transition for 62 days
- [warning] openxFactory:docs/merge-master.md — draft without transition for 62 days
- [warning] openxFactory:docs/omnigent-constitution.md — draft without transition for 62 days
- [warning] openxFactory:docs/pr-admission.md — draft without transition for 62 days
...
- [warning] openxFactory:docs/spec-kit-stage-ownership.md — draft without transition for 62 days
- [warning] openxFactory:docs/traceability-model.md — draft without transition for 62 days
- [warning] openxFactory:docs/tui-spec-questionnaire.md — draft without transition for 63 days
- [warning] openxFactory:docs/workflow-contract.md — draft without transition for 62 days
...
- [error] openxFactory:docs/contract-versioning-policy.md — bytes differ from the digest 'contract-v3.4' records
- [info] openxFactory:contracts/README.md — bytes differ from the digest 'contract-v3.4' records (editorial member — expected between cuts)
- [info] openxFactory:contracts/manifest.yaml — bytes differ from the digest 'contract-v3.4' records (editorial member — expected between cuts)
...
- severity=error family=release-inventory-drift repo=openxFactory path=docs/contract-versioning-policy.md rule="bytes differ from the digest 'contract-v3.4' records" action="cut a release through the bundle realization order; never hand-edit an inventory or contract_bundle_version to make this comparison pass" class="auto-fixable"
...
- severity=warning family=staged-candidate-aging repo=openxFactory path=docs/deployment-worker-model.md rule="draft without transition for 62 days" action="ratify, supersede, or retire the draft" class="contested"
- severity=warning family=staged-candidate-aging repo=openxFactory path=docs/dogfood-content-migration-plan.md rule="draft without transition for 62 days" action="ratify, supersede, or retire the draft" class="contested"
...
- severity=warning family=staged-candidate-aging repo=openxFactory path=docs/feature-decomposition.md rule="draft without transition for 62 days" action="ratify, supersede, or retire the draft" class="contested"
...
- severity=warning family=staged-candidate-aging repo=openxFactory path=docs/merge-council.md rule="draft without transition for 62 days" action="ratify, supersede, or retire the draft" class="contested"
- severity=warning family=staged-candidate-aging repo=openxFactory path=docs/merge-master.md rule="draft without transition for 62 days" action="ratify, supersede, or retire the draft" class="contested"
- severity=warning family=staged-candidate-aging repo=openxFactory path=docs/omnigent-constitution.md rule="draft without transition for 62 days" action="ratify, supersede, or retire the draft" class="contested"
- severity=warning family=staged-candidate-aging repo=openxFactory path=docs/pr-admission.md rule="draft without transition for 62 days" action="ratify, supersede, or retire the draft" class="contested"
...
- severity=warning family=staged-candidate-aging repo=openxFactory path=docs/spec-kit-stage-ownership.md rule="draft without transition for 62 days" action="ratify, supersede, or retire the draft" class="contested"
- severity=warning family=staged-candidate-aging repo=openxFactory path=docs/traceability-model.md rule="draft without transition for 62 days" action="ratify, supersede, or retire the draft" class="contested"
...
- severity=warning family=staged-candidate-aging repo=openxFactory path=docs/workflow-contract.md rule="draft without transition for 62 days" action="ratify, supersede, or retire the draft" class="contested"
...
- severity=info family=release-inventory-drift repo=openxFactory path=contracts/README.md rule="bytes differ from the digest 'contract-v3.4' records (editorial member — expected between cuts)" action="cut a release through the bundle realization order; never hand-edit an inventory or contract_bundle_version to make this comparison pass" class="auto-fixable"
- severity=info family=release-inventory-drift repo=openxFactory path=contracts/manifest.yaml rule="bytes differ from the digest 'contract-v3.4' records (editorial member — expected between cuts)" action="cut a release through the bundle realization order; never hand-edit an inventory or contract_bundle_version to make this comparison pass" class="auto-fixable"
