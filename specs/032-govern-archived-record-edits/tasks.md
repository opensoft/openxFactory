...
- [ ] T011 [US3] Create `openspec/changes/govern-archived-record-edits/evidence/realization-2026-09-08.md`
      ...
      NOT (not a ruling, not a ratification, not a promotion). (FR-013)
...
- [ ] T015 [US3] Run task 4.3's four validators, capture rc and summary lines,
      record them.
- [ ] T016 [US3] Run doc-health on the branch, diff the FINDING SET against
      T004's `main` baseline, and record the diff verbatim — including "empty"
      if it is empty, and including any count that moved only because the
      document grew, stated as such.
...
- [ ] T028 [US2] Add the ONE additive dated realization note to the packet's
      `proposal.md` front-matter area recording that realization adds the
      evidence file and the `docs/document-lifecycle.md` edit task 3.4 names, so
      the ratified enumeration stays true; commit it separately with the
      superseded-enumeration reason stated. (FR-010)
...
- [ ] T029 Re-run the FULL § 4 gate set at the final head (T027/T028 touched
      ...
      final-head and which were interim.
...
- [ ] T032 Copy the feature's checklists' results and the final gate summary into
      the report for STOP (B), then STOP: no PR, no comment, no merge, no archive.
...
- T030 and T031 run together after T029.
