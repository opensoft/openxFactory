...
- [x] T033a VERIFY THE STOP CONDITION AGAINST REPOSITORY STATE, not intention:
      ...
      **CORRECTED 2026-09-09 by `archive-govern-archived-record-edits` (lane
      ...
      on 2026-09-09T12:19:12Z through the pinned CLI 1.12.0, on Brett Heap's
      archive word of 12:15:01Z, and the packet is at
      ...
      **THE RECORD IS NOT WEAKENED BY THE CORRECTION AND IS THE STRONGER FOR
      ...
      branch and on a separate operator word, did, which is exactly the
      separation T033 exists to prove. **EVERY OTHER SENTENCE OF THE RECORD
      STILL HOLDS UNQUALIFIED**, the 0-pull-requests query and the NOT-MERGED
      merge-base included, both being statements about the realization branch at
      its own stop.
