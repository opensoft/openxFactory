...
| **P6** | openxFactory | B5 — the mapping row | 1.1–1.4 | **GATED — runbook 1.2** *and* **BLOCKED on `adopt-medxsoft-repository-identity` task 1.1** | **NOT OPENED**; the row is prepared verbatim at [contracts/repository-identity-row.md](./contracts/repository-identity-row.md) |
