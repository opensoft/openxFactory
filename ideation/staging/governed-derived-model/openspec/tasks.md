...
- [ ] 1.1 Author `contracts/schemas/xfactory-derived-model-conformance.schema.yaml`
...
- [ ] 1.3 Author `docs/governed-derived-model.md` (invariant vocabulary,
...
- [ ] 2.1 Implement `scripts/validate-derived-models.py` (structural
...
- [ ] 2.2 Positive fixtures: one per proof domain shape (Medx governed
      assumptions-forbidden; Adx calibrated synthetic-aggregate;
      Ledgerx calibrated real-entity two-object split).
- [ ] 2.3 Negative fixtures: mutable authority_status; missing
...
- [ ] 3.2 MODIFIED guidance section in `docs/xfactory-domain-factory-model.md`.
- [ ] 3.3 `OPENSPEC_TELEMETRY=0 openspec validate add-governed-derived-model --strict`
