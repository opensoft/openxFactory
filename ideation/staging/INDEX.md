...
- Readiness: **Proposed 2026-07-26** as `add-workbench-branch-sessions` —
  ...
  as the one new server plumbing); SIXTEEN with Brett's 2026-07-26 session
  ...
  but never both); ONE open question parked with a
