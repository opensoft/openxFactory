...
- Exit: three OpenSpec changes in dependency order — (1) neutral
  ...
  but the neutral contract ratifies first. EXIT 1 EXECUTED — proposed
...
- Exit: three OpenSpec changes — (1) neutral `trust-anchor` capability in
  ...
  manifests in per R2. EXIT 1 EXECUTED — proposed 2026-08-21 as
