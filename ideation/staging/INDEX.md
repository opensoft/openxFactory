...
- Sibling: `wallet-carried-work-authority` is staged the SAME DAY on the separate
  branch `stage/wallet-carried-work-authority`. It carries path-scoped grant
