...
- Open questions: delta shape (new capability vs MODIFIED
  ...
  Medx positions on all four recorded in
  `MedxFactory:openspec/changes/add-patient-consent-instrument/design.md`
  (§Feedback): supports the new-schema leaning; authority-basis
  first-class over signer mechanics; amendments as
  transitions-with-deltas; the executed-record check must be hostable
