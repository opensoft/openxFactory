...
- Files: `recurrence-crystallization.md` (primary — decision record,
  ...
  Exit-3 draft workspace: `openspec/` re-seeded 2026-07-29
  (add-capability-steward proposal, design, tasks, and three delta
  slices, each `Status: draft`).
...
- Readiness: Ready to iterate — the 84-claim source packet is individually
  ...
  delta) →
  `add-capability-steward` (DRAFTED 2026-07-29 in the topic's `openspec/`
  workspace — registry, dispatch, proofs, health; 23 requirements — 
  awaiting the proposal gate).
