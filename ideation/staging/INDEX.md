...
- Readiness: **RATIFIED 2026-07-26** as `add-workbench-branch-sessions`
  ...
  as the one new server plumbing); TWENTY-ONE in the ratified change (design
  D1-D21) once Brett's 2026-07-26 session
  ...
  refuse). ZERO open questions remain — every decision is ruled, and what is
