...
- Files: `recurrence-crystallization.md` (primary — decision record,
  ...
  workspace (now the change itself). Exit-2 draft workspace: `openspec/`
  re-seeded 2026-07-29 (add-crystallizer-contracts proposal, design,
  tasks, and four delta slices, each `Status: draft`).
...
- Readiness: Ready to iterate — the 84-claim source packet is individually
  ...
  `add-crystallizer-contracts` (DRAFTED 2026-07-29 in the topic's
  `openspec/` workspace, awaiting the proposal gate) →
