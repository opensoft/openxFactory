...
- Readiness: Ready to iterate — the 84-claim source packet is individually
  ...
  `add-crystallizer-contracts` (RAISED 2026-07-29 — active change,
  partial promotion) →
