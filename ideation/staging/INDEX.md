...
- Readiness: **Proposed 2026-07-26** as `add-workbench-branch-sessions` —
  ...
  as the one new server plumbing); THIRTEEN with Brett's 2026-07-26 session
  ...
  life); THREE open questions parked with
  recommendations in the change's design (squash-vs-merge → merge commit, the
