...
- A conflict inside the vision itself, recorded rather than smoothed: a broken
  ...
  tranche three.
- 7 open questions, none blocking: wallet-presentation mechanics; the exact
