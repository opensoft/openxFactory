...
| [layer-content-materialization](#layer-content-materialization) | ADDED neutral `hermes_domain_overlay` contract + `overlay_path` (openxFactory); hermes-install seeding increment 2 (`layer_content` kernel + materialization) | 1 | Schema change IMPLEMENTED + RELEASED 2026-07-23 (`contract-v1.15` tag verified; codexFactory live overlay passes; change active pending ratification/archive) — increment 2 fully unblocked: proposes as hermes-install OpenSpec + Speckit feature 003 pinning contract-v1.15 |
