...
| [github-administration-plane](#github-administration-plane) | MODIFIED `roles-authority-model` (neutral App-identity tiers); new OpsxFactory-owned `github-administration` capability | 1 | Realized 2026-07-14 — `add-github-app-identity-tiers` (openxFactory) ratified + archived; `add-github-administration-workflow` (OpsxFactory) deterministic realization merged (PR #9, `7860bc1`); live rollout (2.8, 5.1–5.5) remains human-gated |
