...
| [layer-content-materialization](#layer-content-materialization) | ADDED neutral `hermes_domain_overlay` contract + `overlay_path` (openxFactory); hermes-install seeding increment 2 (`layer_content` kernel + materialization) | 1 | First exit COMPLETE (`contract-v1.15`, archived 2026-07-23). Second exit RAISED 2026-07-23: hermes-install `add-layer-content-materialization` (4 ADDED requirements on `layer-content-seeding`, strict-valid) + Speckit feature `003-layer-content-materialization` (spec/plan/tasks, T001–T015) — implementation next |
