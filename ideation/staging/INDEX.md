...
- Readiness: Ready to iterate — the 84-claim source packet is individually
  ...
  `add-pattern-ledger` (RAISED + RATIFIED 2026-07-29 — active change,
  partial promotion, awaiting realization evidence) → `add-crystallizer-contracts` →
