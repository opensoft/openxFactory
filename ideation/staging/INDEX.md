...
- Readiness: RATIFIED 2026-08-07 as `add-openxwallet` (core + agent
  profile; topic folder name unchanged); the enabling insight is that every agent act
