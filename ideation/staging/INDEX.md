...
- **EXIT 3 IS RAISED, 2026-08-29 — the DRAFT change `add-chain-anchoring`**
  ...
  capability of **nine ADDED requirements over 61 scenarios** (52 at the head its
  council judged; its 2026-08-30 fix round and bot round added nine). It builds to the
