...
- Readiness: **Proposed 2026-07-26** as `add-workbench-branch-sessions` —
  ...
  as the one new server plumbing); FIFTEEN with Brett's 2026-07-26 session
  ...
  be able to stop governed work); ONE open question parked with a
  recommendation in the change's design (whether `open-pr` needs the readiness
  gate → NO, readiness guards propose, not save).
