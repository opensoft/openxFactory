...
- **Q3's divergence, in two rounds and recorded as such.** Round 1, verbatim:
  "lets use Kaspa as primary and bitcoin as secondary" — inverting the study's
...
- **State: FULLY RULED, drafting NOT yet green-lit.** Tranche one is draftable on
  Brett's word. The sitting answered the questions; it did not authorize the
  drafting, and this index does not read "ruled" as "authorized to draft".
