...
- Files: `recurrence-crystallization.md` (primary — decision record,
  fragment map, MVP slice, exit path), `steward-contracts.md`,
...
- Readiness: Ready to iterate — the 84-claim source packet is individually
  ...
  `add-crystallizer-contracts` (RAISED + RATIFIED 2026-07-29 — active
  change, partial promotion, awaiting realization evidence) →
