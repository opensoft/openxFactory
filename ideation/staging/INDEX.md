...
| [layer-content-materialization](#layer-content-materialization) | ADDED neutral `hermes_domain_overlay` contract + `overlay_path` (openxFactory); hermes-install seeding increment 2 (`layer_content` kernel + materialization) | 1 | First exit COMPLETE (`contract-v1.15`, archived 2026-07-23). Second exit MERGED 2026-07-23 (hermes-install PR #6, merge 696ec48; all gates green incl. parity vs the canonical validator and the live codexFactory overlay). Ratify + archive `add-layer-content-materialization` next |
