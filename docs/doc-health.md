...
commit it measured at. Row 3 alone was updated once more after that sweep, by PR
[#1015](https://github.com/opensoft/openxFactory/pull/1015) (2026-09-12, issue #965),
to add the second and final grandfather-disposition pass
`report-stale-grandfather-dispositions` promoted; no other row moved and this
note's own commit above still stands for all of them.
