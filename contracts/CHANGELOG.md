...
Counted at the branch point `bbbbeda984353ebaeb67d3e2bb1c73fcb7bac140`
(`origin/main` tip), not inherited:
...
* `docs/contract-versioning-policy.md` — the doxBench chat-turn v1 entry LEAVES
  ...
  `contract-v4.0` with its reason, per the act that did not land, above. The
