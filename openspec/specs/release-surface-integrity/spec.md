...
`contract-v1.39` were each recorded in the changelog and the manifest with no
published tag for weeks — the state this rule was written against — so a rule
anchored on a tag would have been unevaluable for them; they were
retro-published on 2026-08-25 (PR #333), and the rule stands on the general
fact rather than on those three. The inventory FILE at the commit is the
