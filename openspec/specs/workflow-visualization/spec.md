...
Sanction the MIT-licensed tooling stack for workflow-contract visualization
and fix the nine walkthrough views that client validation-UI feature work is
accepted against.
