...
- **WHEN** the ratified service-discovery capability governs the directory read surface (the tenant directory and service estate — organization profile, subscribed service plans, applications and domains — read on one identity, and the provider offers nothing narrower)
