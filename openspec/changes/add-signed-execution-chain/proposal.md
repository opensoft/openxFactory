...
Status: ratified
Proposed: 2026-08-29
Ratified: 2026-08-29 by Brett Heap (repository owner) — in-session via question prompts; record at `openspec/changes/add-signed-execution-chain/review/ratification-2026-08-29.md`
...
**RATIFIED 2026-08-29 by Brett Heap**, in session via question prompts. The
record is `review/ratification-2026-08-29.md`, and it carries the four acts that
reached this packet as four acts rather than one: the seven clarify rulings
(#499, squash `9c501df6`), the drafting green-light the sitting deliberately
withheld, the collapse of #494 and #495 onto this packet, and Narrowing A.

**Ratification authorizes tranche one and nothing beyond it.** It performs no
realization: contract bytes, the validator, the fixtures and the required-check
wiring are a later commission tracked in `tasks.md` §4, and `target_release` is
re-counted at realization rather than spent here. Q2, Q3, Q6 and Q7 govern the
later tranches; they are recorded in this document and **pre-encoded nowhere** —
this packet names no chain, no anchor, no commitment format and no contract-code
posture.
...
- `signed-execution-chain`: the neutral tranche-one chain, **NINE ADDED
  requirements over 45 scenarios**, no `## MODIFIED Requirements` block anywhere
