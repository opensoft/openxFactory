...
The repo-boundary work established that `openWorkflow` owns canonical factory
...
and contracts move into `openWorkflow` without breaking install repos,
...
- `canonical-policy-migration`: Governs copy-first migration of canonical
  ...
  authority, feature decomposition, and traceability into `openWorkflow`.
- `canonical-contract-migration`: Governs copy-first migration of shared
  contracts, schemas, and policy YAML into `openWorkflow/contracts/` with
