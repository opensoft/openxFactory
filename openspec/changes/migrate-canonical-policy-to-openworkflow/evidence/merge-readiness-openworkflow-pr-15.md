...
- `openspec/changes/migrate-canonical-policy-to-openworkflow/specs/reference-proof-placement/spec.md`
- `examples/README.md`
- `examples/project-alfa/`
- `examples/merge-master/`
- `openspec/changes/migrate-canonical-policy-to-openworkflow/evidence/feat-mig-006-reference-examples.md`
- GitHub PR metadata for `opensoft/openWorkflow#15`
...
|---|---:|---|---|
| Placement decision is documented | Yes | `examples/README.md` | Defines openWorkflow, Omnigent-Install, and future factory-lab homes |
...
| Canonical reference examples live in `openWorkflow` | Yes | `examples/project-alfa/`, `examples/merge-master/` | Static examples copied |
