...
This proposal supporting document is non-normative. It defines executable
acceptance intent for the first four Flutter slices. Implementation must bind
each ID to an automated test, a manual evidence step, or both.
