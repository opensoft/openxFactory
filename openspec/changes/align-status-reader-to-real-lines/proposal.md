...
> `authoring.missing_required_headers`, and `generator._header_value` — scans
> real lines through it; `round_trip.py` imports the primitive rather than
