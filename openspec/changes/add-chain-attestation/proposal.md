...
- `signed-execution-chain`: **NINE ADDED requirements over 94 scenarios**, plus
...
- **New code (this change would authorize; realization is a later commission):**
  SEVEN record kinds and two field disciplines in `contracts/signed-execution-chain/`
