...
- `chain-anchoring`: the neutral public anchoring layer and the permissioned
  consent plane, **NINE ADDED requirements over 69 SCENARIOS** (52 scenarios at
  the head the council judged; the 2026-08-30 fix round and its three bot rounds
  added seventeen scenarios and no new requirement), no `## MODIFIED
