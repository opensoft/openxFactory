...
- `chain-anchoring`: the neutral public anchoring layer and the permissioned
  consent plane, **NINE ADDED requirements over 80 SCENARIOS** (52 scenarios at
  the head the council judged; the 2026-08-30 fix round and its seven bot rounds
  added twenty-eight scenarios and no new requirement), no `## MODIFIED
