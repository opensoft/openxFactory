...
PR #616 is a fourth writer of it and of `docs/contract-versioning-policy.md`,
being the `contract-v3.1` cut. That is the whole reason `target_release:` above
