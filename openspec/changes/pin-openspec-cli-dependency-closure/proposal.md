...
Status: ratified
Ratified: Brett Heap, 2026-09-09 — verbatim "ratify 813", heard first-hand by
lane codexfactory-1 (session name codeXfactory-1, session
session_01SaMMgNoPTARduWJ4956UBg); record at
`review/ratification-2026-09-09.md`. No relay: the word was heard in the session
that acted on it.
Proposed: 2026-09-08
Origin: Operator ruling, Brett Heap, 2026-09-08T14:14:49Z, first-hand, in
session, on a four-option packet: *"Vendor a lockfile (Recommended)"*. **That
ruling settled WHICH of four exits is taken and did not ratify this packet's
text**; the text was ratified separately on 2026-09-09 by the word cited above,
after four Copilot review rounds. Two words, one operator, two decisions, both
recorded.
