...
- `README.md`
- `openspec/changes/migrate-canonical-policy-to-openworkflow/evidence/feat-mig-003-pr-admission-merge.md`
- GitHub PR metadata for `opensoft/openWorkflow#12`
...
|---|---:|---|---|
| PR admission policy is canonical in `openWorkflow` | Yes | `docs/pr-admission.md` | Pre-PR gate and packet shape defined |
