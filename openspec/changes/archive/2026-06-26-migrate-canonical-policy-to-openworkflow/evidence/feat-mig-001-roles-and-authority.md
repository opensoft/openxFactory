...
| Leaves install repo source docs in place | Yes | Git diff | This slice changes `openWorkflow` only |
| Updates openWorkflow documentation index | Yes | `README.md` | Adds the canonical role doc |
