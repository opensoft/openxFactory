...
```text
openWorkflow/contracts/schemas/hermes-operational-postgres.sql
```

The Omnigent install compatibility validator confirms the local copy and required contract inventory match the pinned `openWorkflow` contract reference.
