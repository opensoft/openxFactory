...
- `openspec/changes/enable-live-openworkflow-factory/evidence/phase-1-proposal-governance.md`
- GitHub PR metadata for `opensoft/openWorkflow#19`
...
| Base | `main` |
| Head | `feat/enable-live-openworkflow-factory` |
| Changed files | 10 |
| Additions | 453 |
| Deletions | 0 |
| Mergeable | Yes |
...
|---|---:|---|---|
| Runtime OpenSpec change exists | Yes | `openspec/changes/enable-live-openworkflow-factory/` | Proposal, design, tasks, and specs added |
