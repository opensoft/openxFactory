...
- `README.md`
- `openspec/changes/migrate-canonical-policy-to-openxfactory/evidence/feat-mig-002-speckit-stage-ownership.md`
- GitHub PR metadata for `opensoft/openxFactory#11`
