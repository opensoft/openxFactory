...
- `openspec/changes/migrate-canonical-policy-to-openxfactory/evidence/feat-mig-004-decomposition-traceability.md`
- GitHub PR metadata for `opensoft/openxFactory#13`
