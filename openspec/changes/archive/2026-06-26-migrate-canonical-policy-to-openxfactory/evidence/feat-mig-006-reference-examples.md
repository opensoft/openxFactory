...
| Example Type | Home |
|---|---|
| Canonical static workflow examples | `openxFactory/examples` |
...
| Canonical reference examples live in `openxFactory` | Yes | `examples/project-alfa/`, `examples/merge-master/` | Static examples copied only |
