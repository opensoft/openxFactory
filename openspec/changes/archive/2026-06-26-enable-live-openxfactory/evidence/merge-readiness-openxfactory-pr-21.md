...
- `openspec/changes/enable-live-openxfactory-factory/evidence/phase-3-hermes-runtime-control-plane.md`
...
| No production secrets added | Yes | Diff review | Only docs and submodule pin changed in openxFactory. |
