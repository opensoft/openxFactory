...
target_release: none
Status: ratified
Ratified: 2026-08-06 by Brett Heap — record: this change's tasks.md 3.3, "DISCHARGED by disposition, ruled by Brett 2026-08-06 (decision round)", the ruling under which the change was archived; named again in the archive commit `409e399` ("Archive add-lens-gate-verbs under Brett's 3.3 disposition") and in the README row ("Archived 2026-08-06 under Brett's 3.3 disposition"). STATED PRECISELY, because the record's own word is narrower than this header: what Brett ruled on 2026-08-06 was a REALIZATION disposition — that the 3.1 route tests, the 3.2 Playwright smoke, and his 4.4 wheel-verbs human pass are together sufficient realization evidence — and the word "ratified" appears nowhere in this change. It is cited as the ratification because it is the only named human decision on this change's record and is the decision that carried it into the archive; a reader who wants the literal act should read 3.3, not this line. Header and citation added 2026-08-22 by `archive-register-rulings` under Brett's ruling on C2 of `docs/archive-record-discrepancies.md`; the proposal carried no `Status:` line from authoring through archive.
---
