...
Status: ratified
Ratified: Brett's approval of `add-workbench-branch-sessions` on 2026-07-26, after the 5-lens adversarial review (2 findings confirmed and fixed), the rename-completeness audit, and rulings on all six open questions (D16-D21)
---
...
- ADD one human-only gate verb, `open-pr`, which IS "save": push the branch,
  ...
  fired (D21, carried into the requirement — and neither does it consult the
  BLOCKING staged-to-proposal readiness gate): a
