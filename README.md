...
- [amend-mirror-floor-regeneration-merge-authority](openspec/changes/amend-mirror-floor-regeneration-merge-authority/proposal.md)
  ...
  **MAY arm the platform's auto-merge** on its own pull request so the merge
  ...
  act after the arming; and where a rule is unsatisfiable the lane may not widen
  it, add anyone to a bypass list, remove a floor path or enrol itself. **Six
  scenarios added, one carried narrowed, two carried verbatim — nine in the
  block.** **THE REALIZATION IS GATED FOUR DEEP, AND THAT IS THE ONE PLACE THIS
