...
D2), and it was created for the same reason that one was: a seam cannot be
drawn through an import that crosses it in the forbidden direction. OQ-B B-1
creates another for the same reason again, `path_slug.py` (PR #843, a sibling
of the PR that created this file); the two are independent, and this module
neither imports it nor depends on whether it has landed. All three strings
