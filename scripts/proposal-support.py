...
def main() -> None:
    ...
    try:
        ...
        # EXIT 2, AND NOT 1. Exit 1 here has always meant "this change is not
        # archivable"; this is "which tool would archive it is unsettled", which
        # is the exit the pin verifier and the pinned installer both already
        # use. The message is the verifier's own, printed verbatim.
